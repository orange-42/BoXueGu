    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.rl_signature:   //签名的点击事件
                ...
                break;
            case R.id.rl_qq:     //qq的点击事件
                String qq = tv_qq.getText().toString();//获取qq控件上的数据
                Bundle bdqq = new Bundle();
                bdqq.putString("content",qq);//传递界面上的qq数据
                bdqq.putString("qq","QQ");
                bdqq.putInt("flag",3);   //flag传递3时表示修改qq
                enterActivityForResult(ChangeUserInfoActivity.class,
                        CHANGE_QQ,bdqq);//跳转到个人资料修改界面
                break;
            default:
                break;
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data)
    {
        ...
        switch (requestCode){
            ...
            case CHANGE_SIGNATURE://个人资料修改界面回传过来的签名数据
                ...
                break;
            case CHANGE_QQ:   //个人资料修改界面回传过来的qq
                if(data!=null){
