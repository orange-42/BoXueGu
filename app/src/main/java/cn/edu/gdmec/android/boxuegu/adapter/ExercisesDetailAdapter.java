...
import cn.edu.gdmec.android.boxuegu.activity.bean.ExercisesBean;
import cn.edu.gdmec.android.boxuegu.activity.utils.AnalysisUtils;
import cn.edu.gdmec.android.boxuegu.adapter.ExercisesAdapter.ViewHolder;

/**
 * Created by Mr.Zhang on 2018/4/17.
 */
...
public class ExercisesDetailAdapter extends BaseAdapter {
   ...
   //记录点击的位置
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if(convertView==null){
            vh=new ViewHolder();
            convertView=LayoutInflater.from(mContext).inflate(R.layout.execrises_list_item,null);
            ...
            vh.iv_a=(TextView) convertView.findViewById(R.id.iv_a);
            vh.iv_b=(TextView) convertView.findViewById(R.id.iv_b);
            vh.iv_c=(TextView) convertView.findViewById(R.id.iv_c);
            vh.iv_d=(TextView) convertView.findViewById(R.id.iv_d);
        ...
        if(!selectedPosition.contains(""+position)){
            ...
            AnalysisUtils.setABCDEnable(true, vh.iv_a, vh.iv_b,
                    vh.iv_c,vh.iv_d);
