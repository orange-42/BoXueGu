...
public class FindPswActivity extends AppCompatActivity {
    private EditText et_validate_name,et_user_name,et_new_password;
                ...
                if ("security".equals(from)) {//设置密保
                    if (TextUtils.isEmpty(validateName)) {
                        Toast.makeText(FindPswActivity.this,
                                "请输入要验证的姓名", Toast.LENGTH_SHORT).show();
                        return;
                    ...
                    if (TextUtils.isEmpty(userName)) {
                        ...
                        Toast.makeText(FindPswActivity.this, "请输入验证的姓名", Toast.LENGTH_SHORT).show();
                        return;
...
private void savePsw(String userName){
    String md5Psw = MD5Utils.md5(String.valueOf(et_new_password.getText().toString().trim()));//把密码用MD5加密
