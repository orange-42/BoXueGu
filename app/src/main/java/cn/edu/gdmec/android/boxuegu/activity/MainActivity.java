...
private void initBottomBar(){
    ...
    mCourseBtn = findViewById(R.id.main_bottom_bar_course_btn);
    mExerciseBtn = findViewById(R.id.main_bottom_bar_exercises_btn);
    mMyInfoBtn = findViewById(R.id.bottom_bar_myinfo_btn);
    tv_course = (TextView)findViewById(R.id.main_bottom_bar_text_course);
    tv_exercises= (TextView)findViewById(R.id.bottom_bar_text_exercicses);
    tv_myInfo=(TextView)findViewById(R.id.bottom_bar_text_myinfo);
    iv_course=(ImageView)findViewById(R.id.bottom_bar_image_course);
    iv_exercises=(ImageView)findViewById(R.id.bottom_bar_image_exercicses);
...
switch (v.getId()){
    //课程的点击事件
    case  R.id.main_bottom_bar_course_btn:
        clearBottomImageState();
        selectDisplayView(0);
        break;
        //习题的点击事件
    case R.id.main_bottom_bar_exercises_btn:
        clearBottomImageState();
        selectDisplayView(1);
        break;
        //我的点击事件
